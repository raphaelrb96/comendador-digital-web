      ...
      >
        <Container>
          <Grid container className="z-[1] relative overflow-hidden">
            <Grid lg={7} md={7} className="font-serif xs:ml-6 sm:ml-6 md:mb-20 sm:mb-14 xs:mb-14" item>
              <h2 className="heading-4 font-serif font-medium text-gray-100 mb-16 w-[80%] md:mb-12 xs:mb-16 sm:w-[90%] xs:w-[90%]">
              ...
              <div className="mt-[80px] md:mt-[45px] xs:mt-[55px] xs:justify-center sm:justify-center xs:flex sm:flex  landscape:md:mt-[60px]">
                  <Buttons ariaLabel="link for pricing-packages" onClick={click} className="sm:mx-[14px] bg-slate-400 rounded-[4px] lg:min-w-[250px] xl:min-w-[250px] sm:w-[90%] xs:w-[90%] left-0 right-0 items-center font-medium font-serif hover:text-gray-100 uppercase md:mb-[15px]" themeColor={["#4f1b7d", "#7637ad"]} size="xl" color="#fff" title={'COMPRAR AGORA'} />
            ...
            <Grid lg={5} md={5} className="content xs:pl-0 sm:pl-0 pl-6 landscape:px-[15px]" item>
